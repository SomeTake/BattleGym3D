...
// マクロ定義
//*****************************************************************************
#define	TEXTURE_REDGUAGE			_T("data/TEXTURE/hpguage000.png")		// 赤ゲージ用画像
#define	REDGUAGE_POS_X				(100)									// 赤ゲージの表示位置
#define	REDGUAGE_POS_Y				(50)									// 赤ゲージの表示位置
#define	REDGUAGE_SIZE_X				(500)									// 赤ゲージの幅
#define	REDGUAGE_SIZE_Y				(50)									// 赤ゲージの高さ
